...
read \`brain playbook ai\` first, then add these FOUR sections to the twelve
above. They exist because a plan for AI work that omits them is a plan whose
success cannot be judged.
